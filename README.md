...
Mon classement à l'issue de ce challenge est 2/71 avec un AUC ROC sur le test 0.995 (plus que suspect !?). Précisons d'entrée que l'exercice a été biaisé par la nature des données et que les résultats relèvent plus d'astuce que de réelles perforamances de machine learning. 
